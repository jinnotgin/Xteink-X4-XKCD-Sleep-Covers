# Xteinkx4 XKCD Sleep Covers

Generate **portrait-friendly XKCD comics** as **480×800, 24-bit, uncompressed BMP** images for devices that support a “custom sleep screen” via SD card.
